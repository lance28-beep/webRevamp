    ...
    <div className="relative min-h-screen bg-gradient-to-b from-white via-purple-50/30 to-white dark:from-gray-900 dark:via-purple-900/5 dark:to-gray-900 overflow-hidden">
      ...
      <div className="content-container min-h-screen flex flex-col justify-center relative z-10">
        <div className="flex flex-col items-center text-center pt-32 pb-16">
          ...
          <motion.div 
            className="social-links-container backdrop-blur-sm bg-white/80 dark:bg-gray-900/80 p-4 rounded-full border border-gray-100 dark:border-gray-800 shadow-lg"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <a 
              ...
              className="social-link group relative inline-flex items-center justify-center w-12 h-12 mx-2 transition-all duration-300 hover:-translate-y-1"
              aria-label="Facebook"
            >
              ...
              <svg className="social-icon w-6 h-6 transform transition-all duration-300 group-hover:scale-125" fill="currentColor" viewBox="0 0 24 24">
