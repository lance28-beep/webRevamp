...
const SubmissionForm = () => {
  ...
  return (
    <>
      <section id="submit-project" className="relative overflow-hidden bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-800 py-20">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            >
              <span className="inline-block px-4 py-1 rounded-full bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 text-sm font-medium mb-4">
                Start Your Project
              </span>
            ...
            <motion.form 
              ...
              className="relative overflow-hidden backdrop-blur-sm bg-white/80 dark:bg-gray-800/80 p-8 md:p-10 rounded-2xl shadow-xl dark:shadow-2xl-dark border border-gray-100 dark:border-gray-700"
            >
              ...
              <div className="relative space-y-6">
                {/* Form fields remain the same but with enhanced animations */}
                <motion.div
                  initial={{ opacity: 0, x: -20 }}
                  animate={{ opacity: 1, x: 0 }}
                  transition={{ duration: 0.4 }}
                >
                  <label htmlFor="your_Name" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                    Your Name
                  </label>
                  <input
                    type="text"
                    ...
                    required
                    className="w-full px-4 py-3 rounded-lg bg-white/50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent transition-all duration-300 backdrop-blur-sm"
                ...
                >
                  <label htmlFor="What_would_you_like_to_do?" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                ...
                <AnimatePresence>
                  {formData['What_would_you_like_to_do?'] === 'Website Revamp' && (
                    ...
                    >
                      <label htmlFor="Current_Website_URL" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                ...
                >
                  <label htmlFor="Tell_us_more_about_your_project" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-lg bg-white/50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent transition-all duration-300 resize-none backdrop-blur-sm"
                  ></textarea>
                </motion.div>
